...
%type <symIndex> Expr SimpleExpr AddExpr Test TestAndThen IfStatement WhileToken WhileExpr WhileStatement
...
IfStatement	: IF TestAndThen ELSE CompoundStatement 
		{
			//ADD CODE HERE
			emitBranchEnd(instList, symtab, $2);
		}
		| IF TestAndThen
		{
			//ADD CODE HERE
...
WhileStatement  : WhileToken WhileExpr Statement
		{
			//ADD CODE HERE
			emitLoopBranch(instList,symtab,$1,$2);
		}
        ;
...
WhileExpr	: LPAREN Expr RPAREN
		{
			//ADD CODE HERE
			$$ = emitLoopTest(instList,symtab,$2);
		}
		;
