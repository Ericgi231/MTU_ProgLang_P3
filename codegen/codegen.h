...
EXTERN(int, emitComputeVariableAddressFromArray, (DList instList, SymTable symtab, int varIndex, int arrayOffset));
EXTERN(void, emitBranchEnd, (DList instList, SymTable symtab, int endLabelIndex));
EXTERN(static void, createLabel, (char label[50]));
EXTERN(int, emitThen, (DList instList, SymTable symtab, int elseLabelIndex));
EXTERN(int, emitTest, (DList instList, SymTable symtab, int regIndex));
EXTERN(void, emitLoopBranch, (DList instList, SymTable symtab, int beginLabelIndex, int endLabelIndex));
EXTERN(int, emitLoopTest, (DList instList, SymTable symtab, int regIndex));
EXTERN(int, emitLoopEnd, (DList instList, SymTable symtab));
